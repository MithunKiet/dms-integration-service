"""Repository for HMIS order data access."""
...
_ORDER_COLUMNS = (
    "OrderId, OrderNumber, CustomerId, DealerId, OrderDate, "
    "TotalAmount, Status, CreatedAt, ModifiedAt"
)


class HmisOrderRepository(BaseRepository):
    """Provides read access to order data in the HMIS database."""
    ...
    def get_orders_since(
        ...
        """Return a batch of orders modified after *last_sync_value*.
        ...
        Returns:
            A list of dicts containing order fields.
        """
        if last_sync_value:
            sql = f"""
